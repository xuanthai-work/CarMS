...
export default async function ProfilePage() {
  ...
  return (
    <div className="mx-auto max-w-5xl space-y-5">
      {/* Hồ sơ nhân sự */}
      <div className="relative overflow-hidden rounded-3xl bg-sidebar px-6 py-7 text-white shadow-hero sm:px-8">
      ...
      <div className="grid gap-5 lg:grid-cols-[1.35fr_0.85fr]">
        <div className="rounded-2xl border border-hairline bg-surface p-6 shadow-card">
          <h2 className="mb-5 text-base font-bold tracking-tight text-ink">
            Thông tin cá nhân
          </h2>
          ...
          <div className="mt-6 border-t border-hairline pt-5">
            <h3 className="mb-4 text-base font-bold tracking-tight text-ink">
              Lương
            </h3>
